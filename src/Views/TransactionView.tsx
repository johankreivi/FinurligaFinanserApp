...
const TransactionView: FC<ITransactionViewProps> = (props) => {  
    ...
    const bankAccountId: number = state && state.id;                    
    const nameOfBankAccount: string = state && state.nameOfAccount;     
    const bankAccountNumber: number = state && state.bankAccountNumber;     
